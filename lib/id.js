...
var { createFunctionInstance, invoke } = require('./function-class');
...
function ID (pointer) {
  if (typeof this !== 'function') return createFunctionInstance(null, 0, ID, arguments);
...
ID.prototype.ivar = function (name, value) {
  ...
  if (arguments.length > 1) {
    ...
    var ptr = Buffer.alloc(ref.sizeof.pointer);
